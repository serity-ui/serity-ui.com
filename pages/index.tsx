...
export default function Home() {
  ...
  return (
    <div>
      ...
      <main className='h-screen pt-6 dark:bg-slate-700 dark:bg-gradient-to-t dark:from-slate-700 dark:via-slate-800 dark:to-slate-600 bg-white/[0.15] bg-gradient-to-r from-blue-700 via-blue-800 to-blue-600 '>
        <Navbar />
